...
public final class InputLogic {
    ...
    public InputTransaction onCodeInput(final SettingsValues settingsValues,
       ...
       // }
        ...
        mprocessedEvent = processedEvent ;
        mcurrentKeyboardScriptId = currentKeyboardScriptId ;
        handler.sendMessageGetWordAtCursor();
    ...
    public void getWordAtCursorAsync() {
           if (!mConnection.hasSlowInputConnection() && !mWordComposer.isComposingWord()
                && (msettingsValues.isWordCodePoint(mprocessedEvent.mCodePoint) ||
                        mprocessedEvent.mKeyCode == Constants.CODE_DELETE)) {
            mWordBeingCorrectedByCursor = getWordAtCursor(
                   msettingsValues, mcurrentKeyboardScriptId);
        }
        //msettingsValues = 0 ;
        //mprocessedEvent = 0 ;
        //mcurrentKeyboardScriptId = 0 ;
    }
