...
final class SuggestionStripLayoutHelper {
    ...
    static boolean shouldOmitTypedWord(final int inputStyle,
        ...
        final boolean omitTypedWord = (inputStyle == SuggestedWords.INPUT_STYLE_TYPING)
                ...
                //behavior mismatch in case of INPUT_STYLE_TYPING --> discard the typed word
                //while INPUT_STYLE_NONE [like rotate]-->include the typed word
                //in both the cases -->discard the typed word as user has already input it.
