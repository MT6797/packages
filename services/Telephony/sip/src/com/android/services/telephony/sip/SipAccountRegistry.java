    ...
    private final class AccountEntry {
        ...
        boolean startSipService(SipManager sipManager, Context context, boolean isReceivingCalls) {
            ...
            try {
                ...
                if (isReceivingCalls) {
                    /// M: for ALPS02348029 & ALPS02362693 @{
                    // To create PhoneAccountHandle: MO use profile.getProfileName()
                    //                                  --> Baicolin@iptel.org
                    //                               MT use profile.getUriString()
                    //                                  --> Sip:Baicolin@iptel.org
                    // Here we change MT to be same as MO.
                    /* Orignal Code:
                    sipManager.open(
                            mProfile,
