...
public class ConferenceParticipantConnection extends Connection {
    ...
    private void setCapabilities() {
        ...
        /// it checks if VOLTE capability is changed to know SRVCC happened.
        /// If it is belong to SRVCC case, callLogManager will log it as the same conference.
        /// The other purpose of VOLTE capability is that inCallUI will show the participants'
        /// status if there is this capability on the child calls.
