    ...
    public void onSendSessionModifyRequest(final VideoProfile fromProfile,
        ...
        mHandler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                /// M: make conference can also support one way
                Conference conference = mConnection.getConference();
                if (conference != null) {
                    conference.setVideoState(mConnection, requestProfile.getVideoState());
                } else {
