...
public class BeamStatusReceiver extends BroadcastReceiver {
    ...
    private void handleTransferEvent(Intent intent, int deviceType) {
        ...
        Log.d(TAG, "handleTransferEvent, id:" + id + " action:" + action);
        ...
        if (action.equals(ACTION_TRANSFER_DONE)) {
            ...
            Log.d(TAG, "ACTION_TRANSFER_DONE handoverStatus:" + handoverStatus);
            if (handoverStatus == HANDOVER_TRANSFER_STATUS_SUCCESS) {
                ...
                try {
                    ...
                    Log.d(TAG, "ACTION_TRANSFER_DONE  Exception:" + e);
                    e.printStackTrace();
                    Log.d(TAG, "  finishTransfer treat as false");
