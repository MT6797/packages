...
public class BeamTransferManager implements Handler.Callback,
    ...
    void updateNotification() {
        ...
        if (mState == STATE_NEW || mState == STATE_IN_PROGRESS ||
            ...
            Log.d(TAG, "mState == STATE_SUCCESS, mIncoming:"
                + mIncoming + " mTransferId:" + mTransferId);
    ...
    void updateStateAndNotification(int newState) {
        ...
        Log.d(TAG, "updateStateAndNotification newState:" + describeNotificationState(newState));
    ...
    void processFiles() {
        ...
        for (int i = 0; i < mUris.size(); i++) {
            ...
            if (!srcFile.renameTo(dstFile)) {
                ...
                Log.i(TAG, "dstFile.getAbsolutePath():" + dstFile.getAbsolutePath());
    ...
    Intent buildViewIntent() {
        ...
        Log.d(TAG, "buildViewIntent() mPaths.size():" + mPaths.size());
        ...
        Log.d(TAG, "buildViewIntent():  filePath:" + filePath);
        ...
        /// M: @ {
        try {
            Log.d(TAG, "ViewIntent:  uri:" + uri.toString() + " type:" + mMimeTypes.get(filePath));
        } catch (Exception e) {
            Log.d(TAG, "buildViewIntent()  Exception:" + e);
            e.printStackTrace();
        }
        /// }
    ...
    static File generateUniqueDestination(String path, String fileName) {
        ...
        Log.i(TAG, "generateUniqueDestination() path:" + path + "  fileName:" + fileName);
    ...
    private String describeNotificationState(int state) {
        String stateStr = "";
        ...
        case STATE_IN_PROGRESS:
            stateStr = "STATE_IN_PROGRESS";
            break;
        case STATE_W4_NEXT_TRANSFER:
            stateStr = "STATE_W4_NEXT_TRANSFER";
            break;
        case STATE_W4_MEDIA_SCANNER:
            stateStr = "STATE_W4_MEDIA_SCANNER";
            break;
        case STATE_FAILED:
        ...
        case STATE_CANCELLED:
            stateStr = "STATE_CANCELLED";
            break;
        case STATE_CANCELLING:
            stateStr = "STATE_CANCELLING";
            break;
        }
