...
public class mtknfcproxy {
    ...
    static MtkNfcEntry.IP2pLinkManager mP2pLinkManager;

    //constructor
    private mtknfcproxy(Context context, MtkNfcEntry.IP2pLinkManager p2pLinkManager) {
        mContext = context;
        mP2pLinkManager = p2pLinkManager;
    }

    public static void createSingleton(Context context,
                MtkNfcEntry.IP2pLinkManager p2pLinkManager) {
    ...
    public static int get_SEND_STATE_SENDING() {
        return P2pLinkManager.SEND_STATE_SENDING;
    }
