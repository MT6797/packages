...
public class HandoverDataParser {
    ...
    NdefRecord createBluetoothOobDataRecord() {
        ...
        Log.d(TAG, "createBluetoothOobDataRecord()" );
        Log.d(TAG, "mLocalBluetoothAddress:" + mLocalBluetoothAddress);

        synchronized (mLock) {
            if (mLocalBluetoothAddress == null) {
                mLocalBluetoothAddress = mBluetoothAdapter.getAddress();
                Log.d(TAG, "mBluetoothAdapter.getAddress():" + mBluetoothAdapter.getAddress());
            }
