 ...
 */
public class DtaSnepClientTest {

    private static final String TAG = "DtaSnepClientTest";
    ...
    public static final String DATA2 = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. "
        ...
        " Phasellus eu lacus ligula, quis euismod erat. Sed feugiat, ligula at mollis aliquet,"+
        " justo lacus condimentum eros, non tincidunt neque ipsum eu risus. Sed adipiscing dui"+
        " euismod tellus ullamcorper ornare. Phasellus mattis risus et lectus euismod eu "+
        "fermentum sem cursus. Phasellus tristique consectetur mauris eu porttitor. "+
        "Sed lobortis porttitor orci.";

    public DtaSnepClientTest() {
    }

    public void testPutData1ToDefaultServer() throws IOException {
        if (DBG) Log.d(TAG, "testPutData1ToDefaultServer");
    ...
    public void testPutData2ToDefaultServer() throws IOException {
        if (DBG) Log.d(TAG, "testPutData2ToDefaultServer");
        SnepClient client = new SnepClient();
        client.connect();
        client.put(getData2Ndef());
        client.close();
    }
