...
public class Dta2EchoServer {
    ...
    static final String TAG = "Dta2EchoServer";
    ...
    public Dta2EchoServer(Context context) {
        Log.d(TAG, "Dta2EchoServer()");
        ...
        EchoCoOutServer.createSingleton(mContext);
        mEchoCoOutServer = EchoCoOutServer.getInstance();
        //mEchoCoOutServer.start();

        EchoCoInServer.createSingleton(mContext);
        mEchoCoInServer = EchoCoInServer.getInstance();
        //mEchoCoInServer.start();

        Log.d(TAG, "== start connection less ==");


        CTLEchoCoInServer.createSingleton(mContext);
        mCTLEchoCoInServer = CTLEchoCoInServer.getInstance();
        //mCTLEchoCoInServer.start();

        //mCTLEchoCoInServer = new CTLEchoCoInServer(mContext);
        CTLEchoCoOutServer.createSingleton(mContext);
        mCTLEchoCoOutServer = CTLEchoCoOutServer.getInstance();
    ...
    public void onLlcpActivated() {
        ...
        synchronized (this) {
            //if (mEchoCoOutServer != null) {
            //    mEchoCoOutServer.onLlcpActivated();
            //}
            if (mCTLEchoCoInServer != null) {
                mCTLEchoCoInServer.onLlcpActivated();
            }

            if (mCTLEchoCoOutServer != null) {
                mCTLEchoCoOutServer.onLlcpActivated();
            }
    ...
    public void onLlcpDeactivated() {
        ...
        synchronized (this) {
            ...
            if (mCTLEchoCoInServer != null) {
                mCTLEchoCoInServer.onLlcpDeactivated();
            }
            if (mCTLEchoCoOutServer != null) {
                mCTLEchoCoOutServer.onLlcpDeactivated();
            }
    ...
    public void enable() {
        synchronized (this) {
            ...
            try {
                mEchoCoInServer.start();
                mEchoCoOutServer.start();
                mCTLEchoCoInServer.enable();
                mCTLEchoCoOutServer.enable();
            } catch (Exception e) {
    ...
    public void disable() {
        synchronized (this) {
            try {
                mEchoCoInServer.stop();
                mEchoCoOutServer.stop();
                mCTLEchoCoInServer.disable();
                mCTLEchoCoOutServer.disable();
            } catch (Exception e) {
                Log.d(TAG, "Exception :"+e);
                e.printStackTrace();
            }
