...
public class NfcRuntimeOptions {
    ...
    static private final String CFG_FILE_RULES[] = {
        ...
        "BEAM_SEND_FAIL_CNT=9:OPT0=0,OPT1=1,OPT2=2,OPT3=3,OPT4=4," +
            "OPT5=5,OPT6=6,OPT7=7,OPT8=8,OPT9=9",
        "BEAM_RECV_FAIL_CNT=10:OPT0=0,OPT1=1,OPT2=2,OPT3=3,OPT4=4," +
            "OPT5=5,OPT6=6,OPT7=7,OPT8=8,OPT9=9",
        "BEAM_SEND_SLEEP_TIME=11:OPT0=0,OPT1=1,OPT2=2,OPT3=3,OPT4=4," +
            "OPT5=5,OPT6=6,OPT7=7,OPT8=8,OPT9=9",
        "BEAM_RECV_SLEEP_TIME=12:OPT0=0,OPT1=1,OPT2=2,OPT3=3,OPT4=4," +
            "OPT5=5,OPT6=6,OPT7=7,OPT8=8,OPT9=9",
        "BEAM_SETUP_CONNECTIION_TIME=13:OPT0=0,OPT1=1,OPT2=2,OPT3=3,OPT4=4," +
            "OPT5=5,OPT6=6,OPT7=7,OPT8=8,OPT9=9",
        "GSMA_EVT_BROADCAST=14:NO=0,YES=1",
        "SEAPI_SUPPORT_CMCC=15:NO=0,YES=1",
        "HCE_DEFAULT_ROUTE_HOST=16:NO=0,YES=1",
        "SMALL_ANTENNA_SUPPORT=17:NO=0,YES=1"
    };
    ...
    static private final int SMALL_ANTENNA_SUPPORT = 17;
    ...
    static private final int TABLE_BEAM_SEND_FAIL_CNT[]
                                = {0, 5, 10, 30, 40, 50, 60, 70, 80, 90, 100};
    static private final int TABLE_BEAM_RECV_FAIL_CNT[]
                                = {0, 5, 10, 30, 40, 50, 60, 70, 80, 90, 100};
    static private final int TABLE_BEAM_SEND_SLEEP_TIME[]
                                = {0, 2, 5, 10, 15, 20, 30, 40, 50, 60, 100};
    static private final int TABLE_BEAM_RECV_SLEEP_TIME[]
                                = {0, 2, 5, 10, 15, 20, 30, 40, 50, 60, 100};

    static private final int TABLE_BEAM_SETUP_CONNECTION_TIME[]
    ...
    static public boolean isSmallAntennaSupport() {
        int userConfig[] = new int[1];
        boolean ret = false;
        try {
            if (sConfigFileParser.get(SMALL_ANTENNA_SUPPORT, userConfig)) {
                ret = (userConfig[0] == YES) ? true : false;
            }
        } catch (Exception e) { }
        return ret;
