...
extern nfc_jni_discovery_info_t gDiscoveryInfo;  // for DTA2 call discovery...
...
static jboolean com_android_nfc_NativeP2pDevice_doDisconnect(JNIEnv *e, jobject o)
{
    ...
    {
        rDevDeactivate.u1DeactType = 2; // deactivated to SLEEP_TYPE_AF
...
clean_and_return:
    ...
    {
        ret = nfc_jni_enable_discovery_with_info(nat, gDiscoveryInfo);
        ALOGD("%s: nfc_jni_enable_discovery done, response %d", __FUNCTION__, ret);
    }
    //--------------------------------------------------------------
