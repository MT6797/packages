...
public class Profiler {
    ...
    public static final String CallOptionHandlerEnterStartActivity =
            "+CallOptionHandler.StartActivity";
    public static final String CallOptionHandlerLeaveStartActivity =
            "-CallOptionHandler.StartActivity";
    ...
    public static final String CallOptionHelperEnterMakeVoiceCall =
            "+CallOptionHelper.makeVoiceCall";
    public static final String CallOptionHelperLeaveMakeVoiceCall =
            "-CallOptionHelper.makeVoiceCall";
    ...
    public static final String PhoneFavoriteFragmentEnterOnCreate =
            "+PhoneFavoriteFragment.onCreate";
    public static final String PhoneFavoriteFragmentLeaveOnCreate =
            "-PhoneFavoriteFragment.onCreate";
    ...
    public static final String PhoneFavoriteFragmentEnterOnCreateView =
            "+PhoneFavoriteFragment.onCreateView";
    public static final String PhoneFavoriteFragmentLeaveOnCreateView =
            "-PhoneFavoriteFragment.onCreateView";
    ...
    public static final String ViewPagerNewPhoneFavoriteFragment =
            "ViewPager.getItem PhoneFavoriteFragment";
    ...
    public static final String DialtactsActivitySetOffscreenPageLimit =
