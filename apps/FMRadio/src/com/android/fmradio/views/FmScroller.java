...
/// M: [BUG ADD] Correct the layout in multi-window @{
...
public class FmScroller extends FrameLayout {
    ...
    private void showPopupMenu(View anchor, final int frequency) {
        ...
        IFavoriteExt ext = ExtensionHelper.getFavoriteExtension(getContext());
        mPopupMenu = ext.createPopupMenu(getContext(), anchor, frequency);
        /// @}
