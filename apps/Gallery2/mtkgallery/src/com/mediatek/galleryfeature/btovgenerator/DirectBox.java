...
/**
 * Corresponding to a non-full "box" in MP4 spec.
 * A non-full box here stands for a box which has no version and flags in MP4.
 */
class DirectBox extends Box {
    private static final String TAG = "MtkGallery2/DirectBox";
    private static final int OUT_FORMAT_MPEG_4 = 1;
    ...
    private void writeVisualSampleEntry() {
        ...
        FileWriter.writeInt32(0); //pre_defined
        FileWriter.writeInt32(0); //pre_defined
        FileWriter.writeInt16((short) sWidth);
        FileWriter.writeInt16((short) sHeight);
