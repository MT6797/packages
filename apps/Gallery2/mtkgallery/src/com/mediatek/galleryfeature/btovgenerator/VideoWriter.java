...
/**
 * Write raw frame buffer data into a video file.
 */
class VideoWriter {
    private static final String TAG = "MtkGallery2/VideoWriter";
    ...
    private static final float DEFAULT_FPS = 15;
    private static final int MEDIA_TIME_SCALE = 90000;
    ...
    private void initBoxesData() {
        ...
        FullBox.sCreateTime = now;
        FullBox.sFps = mFps;
        FullBox.sFrameNumber = mFrameNumber;
        FullBox.sMediaTimeScale = MEDIA_TIME_SCALE;
        FullBox.sWidth = mWidth;
        FullBox.sHeight = mHeight;
        DirectBox.sWidth = mWidth;
        DirectBox.sHeight = mHeight;

        mStts.add(mFrameNumber, (int) (MEDIA_TIME_SCALE / mFps));
