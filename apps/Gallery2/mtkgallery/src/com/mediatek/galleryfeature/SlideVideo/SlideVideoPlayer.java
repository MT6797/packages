...
public class SlideVideoPlayer extends Player implements IVideoTexture.Listener,
    ...
    protected boolean onPrepare() {
        ...
        if(mPlayer == null) {
            MtkLog.e(TAG, "mPlayer is null, return false");
            return false;
        }
    ...
    protected boolean onStart() {
        ...
        ((AudioManager) mContext.getSystemService(Context.AUDIO_SERVICE)).requestAudioFocus(this,
    ...
    public void onAudioFocusChange(int focusChange){
        MtkLog.d(TAG, "AudioFocusChange state is " + focusChange);
