...
public class PanoramaHelper {
    ...
    private static final float WIDTH_PERCENT_ADJUST_PARAM = 0.04f;

    private static int sMiddleThumbWidth;
    private static int sMiddleThumbHeight;
    ...
    private static void setMiddleThumbSize(int w, int h) {
        sMiddleThumbWidth = w > h ? w : h;
        sMiddleThumbHeight = h > w ? w : h;
        MtkLog.i(TAG, "<setMiddleThumbSize> sMiddleThumbWidth = "
                + sMiddleThumbWidth + ", sMiddleThumbHeight = "
                + sMiddleThumbHeight);
    }
    ...
    public static int getMiddleThumbWidth() {
        return sMiddleThumbWidth;
    }

    public static int getMiddleThumbHeight() {
        return sMiddleThumbHeight;
    }
    ...
    public static float getWidthPercent(int width, int height) {
        ...
        float widthPercent = 1.f - ratio * WIDTH_PERCENT_ADJUST_PARAM;
    ...
    public static PanoramaTexture newPlaceholderPanoramaTexture(MediaData md, int color) {
        ...
        int width;
        int height;
        if (md.orientation == DEGREE_90 || md.orientation == DEGREE_270) {
            height = md.width;
            width = md.height;
        } else {
            height = md.height;
