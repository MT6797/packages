...
public class ThumbnailPlayEngine extends PlayEngine {
    ...
    public final TimeStampComparator mTimeStampComparator = new TimeStampComparator();
    public final AbsTimeStampComparator mAbsTimeStampComparator = new AbsTimeStampComparator();
    ...
    public ThumbnailPlayEngine(Context context, MediaCenter center, int totalCount, int playCount,
            int workThreadNum, ThumbType thumbType) {
        mContext = context;
        mInnerPlayEngine = new PhotoPlayEngine(center, totalCount, playCount, workThreadNum,
                thumbType);
    }
    ...
    private boolean randomLoopPlayers(
        ...
        Collections.sort(items, mTimeStampComparator);
        ...
        Collections.sort(items, mAbsTimeStampComparator);
