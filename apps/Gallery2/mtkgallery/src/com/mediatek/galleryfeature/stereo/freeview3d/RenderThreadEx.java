...
public class RenderThreadEx extends Thread {
    ...
    private static Object mRenderLock = new Object();
    private static boolean mRenderRequested = false;
     ...
     */
    public static void setRenderRequester(boolean request) {
        synchronized (mRenderLock) {
            mRenderRequested = request;
            mRenderLock.notifyAll();
            MtkLog.d(TAG, " <setRenderRequester> mRenderRequested = "
                    + mRenderRequested);
        }
    }
