...
/**
 * Image icon for stereo background.
 *
 */
public class BackgroundView extends IconView {
    private final static String TAG = "MtkGallery2/BackgroundView";
    ...
    public BackgroundView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTextId = R.string.m_stereo_background;
        mDrawableId = R.drawable.m_background;
        mDrawableDisableId = R.drawable.m_background_disable;
    }
