...
public class VideoZoomController implements GestureRecognizer.Listener {
    ...
    // default double tap scale ratio will equal to
    // DOUBLETAP_DEFAULT_PERSENT times max scale ratio.
    ...
    private static float getVideoScaleRatio(
            int defaultDispW, int defaultDispH, int videoW, int videoH) {
    ...
    public int getDispScaleWidth() {
        return Math.round(
            1.0f * getDispScaleHeight() * mDefaultPreviewWidth / mDefaultPreviewHeight);
    }
