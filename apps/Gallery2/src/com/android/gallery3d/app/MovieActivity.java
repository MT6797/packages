...
//                    getString(R.string.share)));
    ...
    public void onDestroy() {
        Log.v(TAG, "onDestroy, mGranted = " + mGranted
                    + ", mTranscodeVideo = " + mTranscodeVideo);
        if (mGranted) {
            mPlayer.onDestroy();
    ...
    private OnChooseActivityListener mChooseActivityListener = new OnChooseActivityListener() {
        ...
        public boolean onChooseActivity(ActivityChooserModel host, Intent intent) {
            if (MtkVideoFeature.isSlowMotionSupport()
                ...
                if (mSlowMotionItem.getSpeed()
                        == SlowMotionItem.SLOW_MOTION_ONE_SIXTEENTH_SPEED ||
                    mSlowMotionItem.getSpeed()
                        == SlowMotionItem.SLOW_MOTION_ONE_THIRTY_TWO_SPEED) {
                    Toast.makeText(
                            getApplicationContext(),
                            getString(R.string.not_avaliable_high_speed_single_share),
