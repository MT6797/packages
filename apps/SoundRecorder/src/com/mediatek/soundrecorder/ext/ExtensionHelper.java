...
public class ExtensionHelper {
    ...
    public static IRecordingTimeCalculationExt getRecordingTimeCalculationExt(Context context) {
        if (sRecordingTimeCalculationExt == null) {
            sRecordingTimeCalculationExt = (IRecordingTimeCalculationExt) MPlugin.createInstance(
                                                   IRecordingTimeCalculationExt.class.getName(),
                                                   context);
            if (sRecordingTimeCalculationExt == null) {
                sRecordingTimeCalculationExt = new DefaultRecordingTimeCalculationExt(context);
            }
        }
