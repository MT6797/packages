...
public class TagViewer extends Activity implements OnClickListener {
    ...
    private static final int VIEWER_REQUEST_CONTACTS = 1;
    private static final int VIEWER_REQUEST_CALL = 0;
    ...
    public void onRequestPermissionsResult(int requestCode,  String[] permissions,
        ...
        if (requestCode == VIEWER_REQUEST_CONTACTS) {
            VCardRecord.onVcardPermissionsResult(requestCode, permissions, grantResults);
        }
        else if (requestCode == VIEWER_REQUEST_CALL) {
            UriRecord.onUriPermissionsResult(requestCode, permissions, grantResults);
        }
