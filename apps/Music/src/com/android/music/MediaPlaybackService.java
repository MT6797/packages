...
public class MediaPlaybackService extends Service {
            ...
            switch (msg.what) {
                ...
                case SERVER_DIED:
                    ...
                    /// we will clear the play list and position.
                        ...
                        /// @}
                        MusicLogUtils.d(TAG, "SERVER_DIED: doseek restored to:"
                         + mDoSeekWhenPrepared);
                        MusicLogUtils.d(TAG, "SERVER_DIED: <- openCurrentAndNext");
                    }
                    break;
    ...
    public void onCreate() {
        ...
        (new OnPlaybackPositionUpdateListener() {
                    ...
                    misAVRCPseeking = true;
                     MusicLogUtils.e(TAG, "seek true");
                    cur_pos  = mPlayer.position();
                     MusicLogUtils.e(TAG, "cur_pos" + cur_pos + " newpos  " + newpos);
            ...
            long dur = duration();
            MusicLogUtils.d(TAG, "duration: " + dur);
            ...
            MusicLogUtils.d(TAG, "seek curr(" + cur_pos + ")");
            ...
            mPlayer.seek(newpos);
                    ...
                    {
                        //MusicLogUtils.d(TAG, "Pause before seek");
                        // mRemoteControlClient.setPlaybackState(
    ...
    private void notifyChange(String what) {
        ...
        MusicLogUtils.e(TAG, "set remote PLAYING" + isPlaying());
    ...
    private void openCurrentAndNext() {
        synchronized (this) {
            ...
            while ((mCursor == null) ||
                !checkDrm(mCursor) || !open(MediaStore.Audio.Media.EXTERNAL_CONTENT_URI +
...
//Not Required
    ...
    private class MultiPlayer {
       ...
       {
            MusicLogUtils.d(TAG, "onCompletion: Blocked by AVRCP seek");
        return;
       }
