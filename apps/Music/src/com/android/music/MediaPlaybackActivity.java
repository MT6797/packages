    ...
    View.OnTouchListener, View.OnLongClickListener, CreateBeamUrisCallback
{
    ...
    /**@}**/
    private boolean longclick_blocked = false;
...
//Not Required
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        {
            longclick_blocked = false;
        }
        if (resultCode != RESULT_OK) {
            return;
        }
         MusicLogUtils.e(TAG, "onActivityResult " + requestCode + " result" + resultCode);
        switch (requestCode) {
            case NEW_PLAYLIST:
       ...
       private void showCreateDialog(String plst_item_id,
                                   int tab_id,
                                   String plst_flag) {
        MusicLogUtils.i(TAG, "showEditDialog>>");
...
*/
    ...
    private long refreshNow() {
        ...
        mDuration = mService.duration();
            ...
            if ((pos >= 0) && (mDuration > 0)) {
                MusicLogUtils.d(TAG, "refreshNow()-pos = " + pos + "Duration: " + mDuration);
    ...
    private BroadcastReceiver mStatusListener = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action == null) {
                MusicLogUtils.e(TAG, "onReceive: action = null");
                return;
            }
