...
public class CreatePlaylist extends DialogFragment
{
    ...
    private static long [] mTempCursor;
    /// M: add for dialog

    private Dialog mDialog;
    /// @}
     public static CreatePlaylist newInstance(String plst_item_id,
                                              int tab_id,
                                              String plst_flag,
                                              String plst_name) {
        CreatePlaylist frag = new CreatePlaylist();
        Bundle args = new Bundle();
        args.putString(MusicUtils.ADD_TO_PLAYLIST_ITEM_ID, plst_item_id);
        args.putInt(MusicUtils.START_ACTIVITY_TAB_ID, tab_id);
        args.putString(MusicUtils.SAVE_PLAYLIST_FLAG, plst_flag);
        args.putString(MusicUtils.PLAYLIST_NAME, plst_name);
