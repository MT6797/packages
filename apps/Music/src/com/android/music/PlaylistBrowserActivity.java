    ...
    implements View.OnCreateContextMenuListener, MusicUtils.Defs
{
    ...
    private final DialogInterface.OnClickListener mDeleteDialogListener =
        ...
        public void onClick(DialogInterface arg0, int arg1) {
            MusicLogUtils.i(TAG, "<mDeleteDialogListener onClick>");
            //deleteItems();
            arg0.dismiss();
        }
    };
    ...
    if (getApplicationContext()
          ...
          != PackageManager.PERMISSION_GRANTED) {
            ...
            MusicLogUtils.d(TAG, "onCreate Permissions granted");
    ...
    public void onDestroy() {
     ...
     private void showRenameDialog(long id) {
        ...
        MusicLogUtils.i(TAG, "<showRenameDialog> fragmentManager = " + fragmentManager);
   ...
   private void showEditDialog() {
        ...
        FragmentManager fragmentManager = getFragmentManager();
        MusicLogUtils.i(TAG, "<showEditDialog> fragmentManager = " + fragmentManager);
