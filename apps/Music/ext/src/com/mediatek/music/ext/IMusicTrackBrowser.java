...
public interface IMusicTrackBrowser {
     ...
     * @internal
     */
    public boolean onOptionsItemSelected(Context context,
    MenuItem item, String activityName, Activity activity,
    PluginUtils.IMusicListenter musicListener, Bundle options);
    ...
    public void onActivityResult(int requestCode,
     int resultCode, Intent intent, Context context,
