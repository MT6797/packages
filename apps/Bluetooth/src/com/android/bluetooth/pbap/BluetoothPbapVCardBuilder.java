...
public class BluetoothPbapVCardBuilder extends VCardBuilder {
     ...
     */
    private BluetoothPbapVCardBuilder appendNamePropertiesV40(
            final List<ContentValues> contentValuesList) {
     ...
     * vCard spec.
     */
    public BluetoothPbapVCardBuilder appendNameProperties(
            final List<ContentValues> contentValuesList) {
        if (VCardConfig.isVersion40(mVCardType)) {
...
//            }
        ...
        if (contentValuesList != null) {
            for (ContentValues contentValues : contentValuesList) {
                ...
                if (Im.PROTOCOL_CUSTOM == protocolAsObject) {
                    ...
                    appendLineWithCharsetAndQPDetection(tmep, parameterList,
                                                        contentValues.getAsString(Im.DATA));
                    continue;
                }
    ...
    public BluetoothPbapVCardBuilder appendOrganizations(
            final List<ContentValues> contentValuesList) {
        if (contentValuesList != null) {
            for (ContentValues contentValues : contentValuesList) {
     ...
     */
    public BluetoothPbapVCardBuilder appendSipAddresses(
            final List<ContentValues> contentValuesList) {
