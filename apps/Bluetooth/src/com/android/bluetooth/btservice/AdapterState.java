...
final class AdapterState extends StateMachine {
    ...
    private static final int BREDR_START_TIMEOUT_DELAY = 8500;
    //BREDR_STOP_TIMEOUT can < STOP_TIMEOUT
    private static final int BREDR_STOP_TIMEOUT_DELAY = 8500;
    /// @}
    ...
    private class BleOnState extends State {
        ...
        public boolean processMessage(Message msg) {
            ...
            switch(msg.what) {
               case USER_TURN_ON:
                   if (DBG) Log.d(TAG, "CURRENT_STATE=BLE ON, MESSAGE = USER_TURN_ON");
               ...
               case USER_TURN_OFF:
                   if (DBG) Log.d(TAG, "CURRENT_STATE=BLE ON, MESSAGE = USER_TURN_OFF");
                ...
                /// M: Whole chip reset @{
                case RESET:
                    if (DBG) Log.d(TAG, "CURRENT_STATE=BLE ON, MESSAGE = RESET");
                    break;
                /// @}

               default:
                   if (DBG) Log.d(TAG, "ERROR: UNEXPECTED MESSAGE: CURRENT_STATE=BLE ON, MESSAGE = "
                           + msg.what);
                   return false;
            }
            return true;
        ...
        public boolean processMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case BREDR_START_TIMEOUT:
                    ...
                    errorLog("BrEdr start timeout! Android native code exists fd leak issue because the services are not stopped");
                    sendMessageDelayed(BREDR_STOP_TIMEOUT, BREDR_STOP_TIMEOUT_DELAY);
