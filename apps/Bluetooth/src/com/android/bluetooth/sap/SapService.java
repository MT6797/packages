...
public class SapService extends ProfileService {
    ...
    private static final int SDP_SAP_VERSION = 0x0101;  // M: Current SAP version is v1.1
    ...
    private void stopSapServerSession() {
        ...
        /// M : ALPS02400089 Use BluetoothAdapter.getState() to check BT status
        int state = mAdapter.getState();
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(BluetoothAdapter.ACTION_STATE_CHANGED)) {
                ...
                if (state == BluetoothAdapter.STATE_TURNING_OFF) {
                    ...
                    sendShutdownMessage();
                    // M: ALPS02323668, Close server session when BT is turning off
                ...
                /// M : ALPS02400089 Ignore this reply when BT is off or turning-off @ {
                int state = mAdapter.getState();
                if (state == BluetoothAdapter.STATE_OFF ||
                        state == BluetoothAdapter.STATE_TURNING_OFF) {
                    return;
