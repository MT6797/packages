...
public class BluetoothMapFolderElement implements Comparable<BluetoothMapFolderElement>{
    ...
    public void printSubFolder(){

        String DebugLog = "";
        for (Object key : mSubFolders.keySet())
        {
             DebugLog = DebugLog + mSubFolders.get(key).mName + " / ";
        }
        Log.i(TAG,"[printSubFolder] Folder = " + mName);
        Log.i(TAG,"[printSubFolder] SubFolder = " + DebugLog);
    }
