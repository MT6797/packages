...
public class Address {
    ...
    private static final String LIST_DELIMITER_LIST = ",";
    private static final char LIST_DELIMITER_EMAIL_START = '<';
    private static final char LIST_DELIMITER_EMAIL_END = '>';
    ...
    public static Address[] unpack(String addressList) {
        ...
        String [] strList = addressList.split(LIST_DELIMITER_LIST);
        int i = 0;
        ...
        for(i = 0; i < strList.length; i++)
        {
            ...
            int addressStartIndex = strList[i].indexOf(LIST_DELIMITER_EMAIL_START);
            int addressEndIndex = strList[i].indexOf(LIST_DELIMITER_EMAIL_END);

            if(addressStartIndex == -1 || addressEndIndex == -1)
                address = new Address(strList[i].substring(0, length), null);
            else
                address = new Address(strList[i].substring(addressStartIndex+1, addressEndIndex),
                                        strList[i].substring(0, addressStartIndex));
