...
#ifdef MTK_BT_AVRCP_TG_1_5
extern void btavrcp_set_addressed_player_callback(int player_id);
extern void btavrcp_get_folder_items_callback(
                                       btrc_get_folder_item_cmd_t *p_getfolder);
extern void btavrcp_get_total_items_num_callback(btrc_browsable_scope_t scope);
#endif
...
static btrc_callbacks_t sBluetoothAvrcpCallbacks = {
    ...
    btavrcp_get_total_items_num_callback,
#endif
};
...
#ifdef MTK_BT_AVRCP_TG_1_5
const btrc_interface_t * getBluetoothAvrcpInterface() {
    return sBluetoothAvrcpInterface;
}
#endif

extern int register_com_mediatek_bluetooth_avrcp(JNIEnv* env);

int register_com_android_bluetooth_avrcp(JNIEnv* env)
{
    if (register_com_mediatek_bluetooth_avrcp(env) < 0) {
        ALOGE("jni mediatek avrcp registration failure.");
        return JNI_ERR;
    }
