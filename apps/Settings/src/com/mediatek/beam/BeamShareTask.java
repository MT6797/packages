...
public class BeamShareTask {
    ...
    public static final String SC_INCOMING_TASK = BeamShareTaskMetaData.TASK_TYPE + " in ("
            + BeamShareTask.TYPE_BLUETOOTH_INCOMING + ","
            + BeamShareTask.TYPE_WIFI_DIRECT_INCOMING + ")";

    // outgoing task:  Wi-Fi outgoing + BT outgoing
    public static final String SC_OUTGOING_TASK = BeamShareTaskMetaData.TASK_TYPE + " in ("
            + BeamShareTask.TYPE_BLUETOOTH_OUTGOING + ","
            + BeamShareTask.TYPE_WIFI_DIRECT_OUTGOING + ")";
    ...
    public BeamShareTask(Cursor cursor) {
        ...
        mData = cursor.getString(cursor.getColumnIndexOrThrow(
                BeamShareTaskMetaData.TASK_OBJECT_FILE));
        mMimeType = cursor.getString(cursor.getColumnIndexOrThrow(
                BeamShareTaskMetaData.TASK_MIMETYPE));

        mTotalBytes = cursor.getLong(cursor.getColumnIndexOrThrow(
                BeamShareTaskMetaData.TASK_TOTAL_BYTES));
        mDoneBytes = cursor.getLong(cursor.getColumnIndexOrThrow(
                BeamShareTaskMetaData.TASK_DONE_BYTES));

        mModifiedDate = cursor.getLong(cursor.getColumnIndexOrThrow(
