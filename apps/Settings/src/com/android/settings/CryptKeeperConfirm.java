...
public class CryptKeeperConfirm extends InstrumentedFragment {
    ...
    public static class Blank extends Activity {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            }, 3000); ///M: ALPS00443516 Add for handling deskclock,
                      /// change delayed time from 700 to 3000 milliseconds.
        }
    }

    private View mContentView;
    private Button mFinalButton;
    private Context mContext; /// M:for CR ALPS00443516
    private Button.OnClickListener mFinalClickListener = new Button.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            ///M: Add for deskclock ,CR ALPS00443516 @{
            if (mContext != null) {
