...
public class SimUtils {
    ...
    private static HashMap<Integer, List<AlphaTag>> sAasMap = new HashMap<Integer, List<AlphaTag>>(
            2);
    ...
    public static void setCurrentSlot(int slotId) {
        sCurSlotId = slotId;
        LogUtils.d(TAG, "setCurrentSlot() sCurSlotId=" + sCurSlotId + " sCurrentAccount="
                + sCurrentAccount);
    }
    ...
    public static void setCurrentSubId(int subId) {
        ...
        LogUtils.d(TAG, "setCurrentSubId() sCurSubId=" + sCurSubId + " sCurrentAccount="
                + sCurrentAccount);
    }
    ...
    public static int getAASTextMaxLength(int subId) {
        ...
        LogUtils.d(TAG, "getAASMaxLength() slot:" + slot + "|maxNameLen:"
        ...
        LogUtils.d(TAG, "getAASMaxLength() end slot:" + slot + "|maxNameLen:"
                + MAX_USIM_AAS_NAME_LENGTH[slot]);
    ...
    public static int getAASMaxCount(int subId) {
        ...
        LogUtils.d(TAG, "[getUSIMAASMaxCount]slot:" + slot + "|maxGroupCount:"
        ...
        LogUtils.d(TAG, "[getUSIMAASMaxCount]end slot:" + slot + "|maxGroupCount:"
                + MAX_USIM_AAS_COUNT[slot]);
    ...
    public static int getAnrCount(int subId) {
        ...
        LogUtils.d(TAG, "[getAnrCount]slot:" + slot + " | MAX_USIM_ANR_COUNT:"
                + MAX_USIM_ANR_COUNT[slot]);

        /*
         * When USIM is not ready, iIccPhb.getAnrCount() returns 0, so we can't
         * be sure whether USIM actually doesn't support additional number or is
         * just not ready, so the following check should be <= 0 and not < 0
         */
        ...
        LogUtils.d(TAG, "[getAnrCount]end slot:" + slot + " | MAX_USIM_ANR_COUNT:"
                + MAX_USIM_ANR_COUNT[slot]);
