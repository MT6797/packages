...
/**
 * Interface definition of checking operator account plugin.
 */
public interface IOperatorAccount {

    /**
     * M: check if need to support syncing of drafts.
     * @param context
     *            context of app
     * @param accountId
     *            user account
     * @return true if requested by OP.
     * @internal
     */
    public boolean isDraftSyncNeeded(Context context, long accountId);

    /**
     * M: check if need to support logical mapping of server folders to client
     * folders.
     * @param context
     *            context of app
     * @param accountId
     ...
     *            user account
     * @param boxes
     *            mapping of local folders with name
     * @param folderName
     *            name of folder
     * @param delimterChar
     *            separator to pick mailbox name
     * @param impObj
