...
/**
 * Default implementation of checking operator account plugin, will be used if
 * the plugin could not be found
 */
public class DefaultOperatorAccount implements IOperatorAccount {

    public String TAG = "DefaultOperatorAccount";

    @Override
    public boolean isDraftSyncNeeded(Context context, long accountId) {
        Log.i(TAG, "Default->isDraftSyncNeeded:FALSE");
        return false;
    ...
    public boolean isFolderOverridingRequired(Context context, long accountId) {
        Log.i(TAG, "Default->isFolderOverridingRequired:FALSE");
        return false;
    ...
    public void updateOperatorMailbox(Context mContext, long accountId,
        ...
        Log.i(TAG, "Default->updateOperatorMailbox");
