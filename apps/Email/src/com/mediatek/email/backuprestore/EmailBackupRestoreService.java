...
public class EmailBackupRestoreService extends IntentService {
    ...
    private static final boolean MTK_CTA_SET = "1".equals(SystemProperties
            .get("ro.mtk_cta_set"));
    ...
    public static void processEmailBackupRestoreIntent(final Context context, Intent intent) {
        // This feature just only for CTA, so if it is not a CTA load, it
        // should just do nothing.
        Log.i(TAG, "MTK_CTA_SET is " + MTK_CTA_SET);
        if (MTK_CTA_SET) {
