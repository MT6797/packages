...
import com.mediatek.email.ext.IOperatorAccount;
...
public class OPExtensionFactory {
    ...
    private static IOperatorAccount sOperatorAccount;
    ...
    /**
     * The "Operator Account" Extension is an Single instance. it would hold the
     * ApplicationContext, and alive within the whole Application.
     * @param context
     *            PluginManager use it to retrieve the plug-in object
     * @return the single instance of "Operator Account" Extension
     */
    public synchronized static IOperatorAccount getOperatorExtension(
            Context context) {
        if (sOperatorAccount == null) {
            sOperatorAccount = (IOperatorAccount) MPlugin.createInstance(
                    IOperatorAccount.class.getName(), context);
            Logging.d(TAG, "use OperatorAccount plugin");
            if (sOperatorAccount == null) {
                Logging.d(TAG, "get plugin failed, use default");
                sOperatorAccount = new DefaultOperatorAccount();
            }
        }
