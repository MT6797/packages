...
public class InvariantDeviceProfileTest extends AndroidTestCase {
    ...
    private static final String TAG = "InvariantDeviceProfileTest";
    ...
    public void testFindClosestDeviceProfile2() {
        debugLog("testFindClosestDeviceProfile2()");
        ArrayList<InvariantDeviceProfile> closestProfiles = null;
        for (InvariantDeviceProfile idf: mPredefinedDeviceProfiles) {
            ...
            debugLog("closestProfile : " + closestProfiles.get(0) + " idf : " + idf);

            if (closestProfiles.get(0).equals(idf)) {
                 break;
            }
        }
    }
