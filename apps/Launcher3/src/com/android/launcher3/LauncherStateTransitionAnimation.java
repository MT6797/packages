...
public class LauncherStateTransitionAnimation {
    ...
    private AnimatorSet startAnimationToWorkspaceFromOverlay(
            ...
            final int toWorkspacePage, final View buttonView,
            final View fromView, final View contentView, final View revealView,
            final View overlaySearchBarView, final boolean animated,
    ...
    private void startWorkspaceSearchBarAnimation(AnimatorSet animation,
            final Workspace.State fromWorkspaceState,
            final Workspace.State toWorkspaceState, int duration,
