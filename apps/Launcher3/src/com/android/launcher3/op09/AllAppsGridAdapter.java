...
public class AllAppsGridAdapter extends RecyclerView.Adapter<AllAppsGridAdapter.ViewHolder> {
    ...
    public AllAppsGridAdapter(Launcher launcher, AlphabeticalAppsList apps,
        ...
        ///M. op09
        mSupportEditAndHideApps = LauncherExtPlugin.getInstance().getWorkspaceExt(mLauncher)
                .supportEditAndHideApps();

        //mGridLayoutMgr.stackFromEnd(true);
        ...
        switch (viewType) {
            ...
            case SEARCH_MARKET_DIVIDER_VIEW_TYPE:
                return new ViewHolder(mLayoutInflater.inflate(
                        R.layout.all_apps_search_market_divider,
                        parent, false));
        ...
        switch (holder.getItemViewType()) {
            case ICON_VIEW_TYPE: {
                ...
                if (mSupportEditAndHideApps) {
                    ...
                    ///M. OP09, for edit mode,delete button.
            ...
            case FOLDER_VIEW_TYPE: {
                ...
                icon = FolderIcon.fromXml(icon, R.layout.folder_icon, mLauncher,
    ...
    /**
      * M: op09 The app is system app or not.
      *
