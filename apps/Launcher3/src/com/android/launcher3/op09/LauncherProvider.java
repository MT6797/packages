...
public class LauncherProvider extends ContentProvider {
    ...
    static DatabaseHelper mOpenHelper;   //op09 @Thunk -> static
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper implements LayoutParserCallback {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            ManagedProfileHeuristic.processAllUsers(
                Collections.<UserHandleCompat>emptyList(), mContext);
        }
        ...
        private void removeOrphanedItems(SQLiteDatabase db) {
            ...
            // AND container NOT IN (SELECT _id FROM favorites WHERE itemType = 2)"
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            switch (oldVersion) {
                ...
                case 19: {
                    ...
                    String operatorA = SystemProperties.get("ro.operator.seg", null);

                    Log.d(TAG, "onUpgrade, operator = " + operator
                        + ",operatorA:" + operatorA);
                    if (operator != null && operator.equals(OPERATOR_OP09)
                            && operatorA != null && operatorA.equals(SEGDEFAULT)) {
