...
public class FolderIcon extends FrameLayout implements FolderListener {
    ...
    public void onDragEnter(Object dragInfo) {
        ...
        if (Launcher.mSupportEditAndHideApps && mIsPageViewFolderIcon) {
            ...
            //layout.showFolderAccept(mFolderRingAnimator); //should add in RecyclerView
        } else {
    ...
    private PreviewItemDrawingParams computePreviewItemDrawingParams(int index,
        ...
        float transY = mAvailableSpaceInPreview - (offset + scaledSize +
            scaleOffsetCorrection) + getPaddingTop();
    ...
    public boolean isRingState() {
        if (LauncherLog.DEBUG_DRAG) {
            LauncherLog.d(TAG, "isRingState: mFolderRingAnimatorState = "
                + mFolderRingAnimatorState);
        }
