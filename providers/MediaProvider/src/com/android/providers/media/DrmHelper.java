...
public class DrmHelper {
    ...
    /**
     * Check whether the given process can access DRM files when OMA DRM enable on device, if not,
     * permit all.
     *
    ...
    public static boolean isPermitedAccessDrm(Context context, int pid) {
        ...
        return (getPermittedState(context, pid) & STATE_PERMIT_ACCESS_DRM) > 0;
    }
