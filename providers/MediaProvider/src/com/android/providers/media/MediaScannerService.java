...
public class MediaScannerService extends Service implements Runnable
{
    ...
    public void run()
    {
        ...
        MtkLog.d(TAG,"mServiceHandler initialized");
    ...
    private BroadcastReceiver mUnmountReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            synchronized (this) {
                ...
                Message msg = mServiceHandler.obtainMessage(MSG_SCAN_DIRECTORY,
                    startId,
                    -1,
                    arguments);
                mServiceHandler.sendMessageDelayed(msg, 10000);
                MtkLog.v(TAG, "sdcard eject, stop scan to avoid sdcard unmount fail"
                    +  "and do scan later(10s) if need");
            }
        }
    };
