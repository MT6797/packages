...
public class SizeLimitActivity extends Activity
    ...
    private void showDialog(Cursor cursor) {
        ...
        /// M: This builder has been created already before.
        // AlertDialog.Builder builder = new AlertDialog.Builder(this, AlertDialog.THEME_HOLO_DARK);
        if (isWifiRequired) {
    ...
    public void onCancel(DialogInterface dialog) {
        ...
        dialogClosed();
            ...
            Log.d(Constants.DL_ENHANCE, "SizeLimitActivity.onCancel:FileAlreadyExist," +
    ...
    public void onClick(DialogInterface dialog, int which) {
        ...
        if (isRequired && which == AlertDialog.BUTTON_NEGATIVE) {
            ...
            if (which == AlertDialog.BUTTON_NEGATIVE) {
                ...
                Log.d(Constants.DL_ENHANCE, "SizeLimitActivity.onClick:FileAlreadyExist," +
        ...
        String whereClause = Downloads.Impl._DATA + " = ?";
                ...
                Log.i(Constants.DL_ENHANCE, "SizeLimitActivity.onClick:FileAlreadyExist," +
                ...
                try {
                    ...
                    if (cursor != null && cursor.moveToFirst()) {
                        ...
                        if (downloadID != currentDownloadID) {
                            ...
                            Log.d(Constants.DL_ENHANCE, "SizeLimitActivity: downloadID is: " +
