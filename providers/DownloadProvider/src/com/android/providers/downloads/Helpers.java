...
public class Helpers {
    ...
    static void ensureDirectoryExist(String fullPath) {
        if (null != fullPath) {
            ...
            if (!downloadDir.exists()) {
                downloadDir.mkdirs();
                Log.v(Constants.DL_ENHANCE, "Full path: " + fullPath + " isn't exist" +
    ...
    static String generateSaveFile(Context context, String url, String hint,
        ...
        sContext = context;
        Log.i(Constants.DL_ENHANCE, "Helpers, mimeType is: " + mimeType +
    ...
    private static String generateAvailableFilenameLocked(
        ...
        if (!sIsDDFile && (result != -1) && (hint != null)
            ...
            Log.w(Constants.DL_ENHANCE, "name: " + name);
            ...
            if (result == NOT_CONTINUE_DOWNLOAD) {
                ...
                Log.d(Constants.DL_ENHANCE, "Helper.generateSaveFile: chooseUniqueFilename, " +
