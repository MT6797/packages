...
public class RangeDownloadHandler {
    ...
    public synchronized void processRangeDownload(Context context, URL url, long contentLength,
        ...
        if (info.mAvgBlockLength == 0) {
            ...
            Log.v(Constants.TAG, "processRangeDownload cut file, avgBlockLength = " + blockLength);
        ...
        try {
            ...
            for (cursor.moveToFirst(); !cursor.isAfterLast(); cursor.moveToNext()) {
                ...
                try {
                    ...
                    Log.v(Constants.TAG, "ProcessRangeDownload:parse urlString: " + urlString
                            + " happen error");
                    throw new StopRequestException(STATUS_BAD_REQUEST, e);
                }

                Log.v(Constants.TAG, "Query subDownload, downloadId: " + downloadId
                ...
                if (!Downloads.Impl.isStatusSuccess(status)) {
                    ...
                    Log.v(Constants.TAG, "Insert to thread pool, downloadId: "
    ...
    private void saveRangedownloadInfo(Context context, long blockLength, long contentLength,
        ...
        for (int i = 0; i < Constants.DEFAULT_BLOCKS; i++) {
            ...
            Log.v(Constants.TAG, "Save RangeDownload info, "
